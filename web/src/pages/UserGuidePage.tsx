    ...
    <div className="fade-in-up">
      ...
      <SegmentedFrame>
        <div>
          ...
          <p className="text-muted small mb-3">在用户面板进入「API 令牌」页面创建令牌。令牌仅展示一次，请妥善保存。</p>
        ...
        <div>
          ...
          <p className="text-muted small mb-3">推荐使用 OpenAI 兼容方式接入。将基础地址指向 Realms，再填入上一步创建的令牌。</p>
