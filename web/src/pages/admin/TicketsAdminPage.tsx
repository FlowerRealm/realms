    ...
    <div className="fade-in-up">
      <SegmentedFrame>
        ...
        <div>
          ...
          <div className="card shadow-sm border-0 overflow-hidden mb-0">
            {loading ? (
                      ...
                      <tr key={t.id}>
                        ...
                        <td>
                          <div className="d-flex align-items-center">
                            <div className="bg-light rounded-circle p-1 me-2 text-primary d-flex align-items-center justify-content-center" style={{ width: 24, height: 24 }}>
