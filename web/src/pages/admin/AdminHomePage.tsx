      ...
      <SegmentedFrame>
        ...
        <div className="row g-4 mb-0">
          <div className="col-md-4">
            <div className="card h-100 border-0 shadow-sm metric-card mb-0" style={{ borderTop: '3px solid var(--bs-primary)' }}>
          ...
          <div className="col-md-4">
            <div className="card h-100 border-0 shadow-sm metric-card mb-0" style={{ borderTop: '3px solid var(--bs-success)' }}>
              <div className="card-body d-flex align-items-center">
          ...
          <div className="col-md-4">
            <div className="card h-100 border-0 shadow-sm metric-card mb-0" style={{ borderTop: '3px solid var(--bs-info)' }}>
              <div className="card-body d-flex align-items-center">
